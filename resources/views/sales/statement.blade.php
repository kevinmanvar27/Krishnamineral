                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <div class="mb-4 party-section">
                                        ...
                                        <div class="mb-3 challan-section challan-header">
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                <h5 class="mb-0">Challan: {{ $challanData['challanNumber'] }}</h5>
                                                <button type="button" class="btn btn-sm btn-primary print-challan" data-challan="{{ $challanId }}">
                                                    <i class="bx bx-printer"></i> Print
                                                </button>
                                            </div>
                                            <table class="table table-striped table-bordered challan-table" style="width:100%">
                                                <thead>
                                                    <tr class="border-b">
                                                        <th>Date</th>
                                        ...
                                        <table class="table table-bordered grand-total-table">
                                            <tfoot>
                                                <tr class="table-success">
                                                    <th colspan="6" class="text-end grand-total-label">Grand Total:</th>
                                                    <th class="text-end grand-total-value">Net Weight - {{ number_format($grandTotalNetWeight, 2) }}</th>
                                                    <th class="text-end grand-total-value">Party Weight - {{ number_format($grandTotalPartyWeight, 2) }}</th>
                                                    <th class="text-end grand-total-value">Total Amount - {{ number_format($grandTotalAmount, 2) }}</th>
                                                </tr>
                                            </tfoot>
                                        </table>
                                    </div>
