                            ...
                            @csrf
                                <div class="card-body general-info">
                                    ...
                                    <div class="border border-2 shadow-md rounded p-3">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="work_timing_enabled" id="work_timing_no" value="0" {{ old('work_timing_enabled') == '0' ? 'checked' : (old('work_timing_enabled') !== '1' ? 'checked' : '') }}>
                                            <label class="form-check-label" for="work_timing_no">NO</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="work_timing_enabled" id="work_timing_yes" value="1" {{ old('work_timing_enabled') == '1' ? 'checked' : '' }}>
                                        ...
                                        <div id="workTimingFields" class="d-none mt-3">
                                            <div class="row">
                                                <div class="col-lg-6 mb-3">
                                                    ...
                                                    <input type="number" name="work_timing_initiate_checking" class="form-control" id="work_timing_initiate_checking" value="{{ old('work_timing_initiate_checking') }}" placeholder="e.g., 30 (minutes after which to alert)">
