                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="card stretch stretch-full">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <div class="card-header-action">
                                    <div class="card-header-btn">         
                                        <a class="btn btn-sm btn-primary" href="{{ isset($vehicle) ? route('purchaseVehicle.editIndex') : route('purchaseVehicle.index') }}">
                            ...
                            <hr class="mt-0">
                            <form method="POST" action="{{ isset($vehicle) ? route('purchaseVehicle.update', $vehicle->id) : route('purchaseVehicle.store') }}">
                            @csrf
                            @if(isset($vehicle))
                                @method('PUT')
                            @endif
