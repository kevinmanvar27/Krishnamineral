                            ...
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <div class="card-header-action">
                                    <div class="card-header-btn">         
                                        <a class="btn btn-sm btn-primary" href="{{ isset($drivers) ? route('purchaseDriver.editIndex') : route('purchaseDriver.index') }}">
                                            <i class="bx bx-arrow-to-left"></i>
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <form method="POST" action="{{ isset($drivers) ? route('purchaseDriver.update', $drivers->id) : route('purchaseDriver.store') }}" enctype="multipart/form-data">
                            @csrf
                            @if (isset($drivers))
                                @method('PUT')
                            @endif
